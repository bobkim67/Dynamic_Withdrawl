...
[DEPRECATED] This file is being replaced by viewer.py.
Use 'streamlit run viewer.py' instead.
"""
...
try:
    ...
    render_dynamic_strategies_tab = None
...
def main():
    ...
    if 'results' in st.session_state and st.session_state['results']:
        ...
        # ====================================================================
        with tab3:
            if render_dynamic_strategies_tab is not None:
                render_dynamic_strategies_tab(data)
            else:
                st.warning("Dynamic Strategy UI module (dynamic_strategy_ui.py) not found. Use viewer.py instead.")
