...
class PortfolioCalculator:
    ...
    def calculate_portfolio_returns(returns_df: pd.DataFrame, 
        ...
        if not np.isclose(total_weight, 1.0, atol=0.01):
            print(f"⚠️  {portfolio_name} 가중치 합: {total_weight*100:.2f}%")
        ...
        for asset_name, weight in weights_decimal.items():
            ...
            if benchmark_name not in returns_df.columns:
                print(f"⚠️  {portfolio_name}: '{benchmark_name}' 벤치마크를 찾을 수 없습니다")
                continue
    ...
    def add_portfolios_to_returns(returns_df: pd.DataFrame,
        ...
        for port_name in selected_portfolios:
            if port_name not in portfolios:
                print(f"⚠️  '{port_name}' 포트폴리오를 찾을 수 없습니다")
                continue
            ...
            print(f"  ✅ {port_name}: 연수익률 {annual_return:.2f}%, 연변동성 {annual_vol:.2f}%")
...
class DataPreprocessor:
    ...
    def _calculate_returns(self):
        ...
        print(f"✅ ({len(self.returns):,}개 수익률)")
...
if __name__ == "__main__":
    ...
    # 데이터 로드
    data = pd.read_pickle('/mnt/user-data/uploads/benchmark_data.pkl')
    ...
    fig1 = visualizer.plot_all_paths(
        ...
        wr=0.04,
        max_paths=500,
        save_path='/mnt/user-data/outputs/paths_port4_wr4.png'
    )
    plt.close()
    ...
    fig2 = visualizer.plot_all_paths(
        ...
        wr=0.04,
        max_paths=500,
        save_path='/mnt/user-data/outputs/paths_port6_wr4.png'
    )
    plt.close()
    ...
    fig3 = visualizer.plot_all_paths(
        ...
        wr=0.06,
        max_paths=500,
        save_path='/mnt/user-data/outputs/paths_port6_wr6.png'
    )
    plt.close()
    ...
    fig4 = visualizer.plot_terminal_values_by_start_date(
        ...
        horizon_years=10,
        wr=0.04,
        save_path='/mnt/user-data/outputs/terminal_by_date_port4.png'
    )
    plt.close()
    ...
    fig5 = visualizer.plot_terminal_values_by_start_date(
        ...
        horizon_years=10,
        wr=0.04,
        save_path='/mnt/user-data/outputs/terminal_by_date_port6.png'
    )
    plt.close()
    ...
    fig6 = visualizer.plot_all_paths(
        ...
        wr=0.04,
        max_paths=500,
        save_path='/mnt/user-data/outputs/paths_us_growth_wr4.png'
    )
    plt.close()
    ...
    fig7, stats7 = visualizer.plot_failure_rate_by_start_month(
        ...
        horizon_years=10,
        wr=0.04,
        save_path='/mnt/user-data/outputs/monthly_stacked_port4.png'
    )
    plt.close()
    ...
    fig8, stats8 = visualizer.plot_failure_rate_by_start_month(
        ...
        horizon_years=10,
        wr=0.04,
        save_path='/mnt/user-data/outputs/monthly_stacked_port6.png'
    )
    plt.close()
    ...
    fig9, stats9 = visualizer.plot_failure_rate_by_start_month(
        ...
        horizon_years=10,
        wr=0.04,
        save_path='/mnt/user-data/outputs/monthly_stacked_us_growth.png'
    )
    plt.close()
    
    print("\n" + "=" * 60)
    print("✅ 모든 시각화 완료! (누적 막대 포함)")
    print("=" * 60)
